...
<html lang="en" data-bs-theme="auto">
  <head><script src="../asset/js/color-modes.js"></script>
    ...
    <link rel="icon" type="image/x-icon" href="<?= $main_url ?>asset/gambar/icon.png">
...
<main class="form-signin w-100 m-auto">
  <form action="proses-login.php" method="post">
    <img class="mb-4" src="<?= $main_url ?>asset/gambar/icon.png" alt="" width="72" height="57">
    ...
    <p class="mt-5 mb-3 text-white">&copy; Web Rekam Medis</p>
  </form>
</main>
