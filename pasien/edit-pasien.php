        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" name="gender" id="gender" value="W" required <?= ($pasien['gender'] == 'W') ? 'checked' : '' ?>>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="tel" name="telpon" class="form-control" id="telpon" placeholder="telpon pasien" pettern="[0-9]{8,}" title="minimal 8 angka" value="<?= $pasien['telpon'] ?>" required>
                </div>
                <div class="form-group mb-3">
