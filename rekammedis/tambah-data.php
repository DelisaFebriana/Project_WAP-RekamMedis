...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a href="<?= $main_url ?>rekammedis" class="text-decoration-none"><i class="bi bi-arrow-left align-top"></i> Kembali</a>
      </div>
        ...
        <div class="row">
            <div class="col-lg-6 pe-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="tgl" class="form-control" id="tgl" value="<?= date('Y-m-d') ?>" readonly>
                </div>
                <div class="form-group mb-3">
                    ...
                    <textarea name="" id="alamatPasien" class="form-control " placeholder="keluhan pasien tentang penyakitnya" ></textarea>
                </div> 
                <div class="form-group mb-3">
                    <label for="keluhan" class="form-label">Keluhan</label>
                    <textarea name="keluhan" id="keluhan" class="form-control" placeholder="alamat pasien" ></textarea>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#tokenfield').tokenfield({
            autocomplete: {
             source: [<?php echo '"' . implode('","', $namaObat) . '"' ?>],
             delay: 100
            },
